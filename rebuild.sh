...
if [ $DIST = 'lucid' ]; then
  ...
  PACKAGES="vdr-plugin-dbus2vdr vdr-plugin-advchctrl vdr-plugin-alcd vdr-plugin-arghdirector vdr-plugin-atscepg vdr-plugin-autosort vdr-plugin-autostart vdr-plugin-avards vdr-plugin-avolctl vdr-plugin-bewegung vdr-plugin-bgprocess vdr-plugin-block vdr-plugin-calc vdr-plugin-cdda vdr-plugin-cdplayer vdr-plugin-channellists vdr-plugin-chanorg vdr-plugin-cinebars vdr-plugin-control vdr-plugin-dbus vdr-plugin-devstatus vdr-plugin-director vdr-plugin-dummydevice vdr-plugin-dvd vdr-plugin-dvdswitch vdr-plugin-dynamite vdr-plugin-eepg vdr-plugin-epgsearch vdr-plugin-extb vdr-plugin-extrecmenu vdr-plugin-femon vdr-plugin-fepg vdr-plugin-filebrowser vdr-plugin-freecell vdr-plugin-fritzbox vdr-plugin-games vdr-plugin-graphtft vdr-plugin-image vdr-plugin-imdbsearch vdr-plugin-infosatepg vdr-plugin-iptv vdr-plugin-karaoke vdr-plugin-lastfm vdr-plugin-lcr vdr-plugin-lircrc vdr-plugin-loadepg vdr-plugin-mailbox vdr-plugin-markad vdr-plugin-mcli vdr-plugin-menuorg vdr-plugin-mlist vdr-plugin-mousemate vdr-plugin-mp3 vdr-plugin-muggle vdr-plugin-music vdr-plugin-newsticker vdr-plugin-noepgmenu vdr-plugin-nordlichtsepg vdr-plugin-osdpip vdr-plugin-osdserver vdr-plugin-osdteletext vdr-plugin-osdtest256 vdr-plugin-pilot vdr-plugin-pim vdr-plugin-pin vdr-plugin-playlist vdr-plugin-podcatcher vdr-plugin-prefermenu vdr-plugin-proxy vdr-plugin-radio vdr-plugin-radiolist vdr-plugin-recstatus vdr-plugin-remote vdr-plugin-remoteosd vdr-plugin-remotetimers vdr-plugin-rotor vdr-plugin-rssreader vdr-plugin-scheduler vdr-plugin-screenshot vdr-plugin-skinelchi vdr-plugin-skinenigmang vdr-plugin-skinsoppalusikka vdr-plugin-sleeptimer vdr-plugin-span vdr-plugin-spider vdr-plugin-streamdev vdr-plugin-suspendoutput vdr-plugin-text2skin vdr-plugin-tvm2vdr vdr-plugin-vnsiserver vdr-plugin-wirbelscan vdr-plugin-xine vdr-plugin-xineliboutput vdr-plugin-live vdr-plugin-sundtek"
fi
